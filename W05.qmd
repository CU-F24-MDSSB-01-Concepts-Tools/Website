...
if (!file.exists("data/galton_data.xlsx")) {
  download.file(url = "https://github.com/CU-F24-MDSSB-01-Concepts-Tools/Website/blob/main/data/galton_data.xlsx", 
                destfile = "data/galton.csv")
} 
if (!file.exists("data/Viertelfest.csv")) {
  download.file(url = "https://github.com/CU-F24-MDSSB-01-Concepts-Tools/Website/blob/main/data/Viertelfest.csv", 
                destfile = "data/Viertelfest.csv")
} 
galton <- read_excel("data/galton_data.csv")
...
range(viertel$Schätzung) # Oh, range in R gives us a vector of min and max. So, we diff
...
$n$th raw moment: $\frac{1}{n}\sum_i^n x_i^n$.  
